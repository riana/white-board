...
gulp.task('vulcanize', function () {
	...
	.pipe(vulcanize({
			...
			excludes: [
				...
				appDir + '/bower_components/highlightjs/highlight.pack.js'
			],
			// stripExcludes: false,
			stripComments: true
		}))
...
gulp.task('copy-libs', function () {
	return gulp.src([
		appDir + '/bower_components/{webcomponentsjs,platinum-sw,sw-toolbox,promise-polyfill,crossroads,hasher,font-awesome,highlightjs}/**/*'
